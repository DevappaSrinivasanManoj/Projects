...
latitude = "12.9716"  # Replace with your latitude
longitude = "77.5946"  # Replace with your longitude
...
with open("daily_solar_data.csv", "a", newline="") as file:
    ...
    if file.tell() == 0:
        writer.writerow(["Date", "Avg Temperature (°C)", "Avg Humidity (%)", "Avg Cloud Cover (%)", "Avg Wind Speed (m/s)", "Total Precipitation (mm)", "Is it Heated"])
    # Write daily data
